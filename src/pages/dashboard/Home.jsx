...
// Datos simulados locales (luego vendrán de la API)
...
export const DashboardHome = () => {
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {/* --- SECCIÓN 1: TARJETAS DE RESUMEN (Bento Grid Top) --- */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="relative overflow-hidden border-indigo-100">
          ...
          <h3 className="text-3xl font-bold text-slate-800 mt-1">$1,820,000</h3>
      ...
      {/* --- SECCIÓN 2: GRÁFICOS Y TRANSACCIONES --- */}
        ...
        <div className="space-y-6">
          <Card className="bg-slate-900 text-white !border-none">
             <div className="flex justify-between items-start mb-8">
                <div>
                  <p className="text-slate-400 text-sm">Disponible en Nequi</p>
                  <h3 className="text-3xl font-bold mt-1">$450,000</h3>
                </div>
